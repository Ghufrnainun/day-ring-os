...
export default function RegisterPage() {
  ...
  async function handleRegister(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      // Supabase default behavior: if email confirmation is enabled, it returns user but session is null.
      // If disabled, it signs them in.
      // We will assume they might need to check email, or if auto-confirmed, redirect.
      // For best UX, show a success message or redirect to a verify page if session is missing.

      // Checking for session if immediate login is allowed
      const {
        data: { session },
    ...
    <div className="w-full space-y-6">
      <div className="space-y-2 text-center">
        ...
        <p className="text-muted-foreground text-sm">
          Start your journey to a more peaceful productivity.
        </p>
      </div>
